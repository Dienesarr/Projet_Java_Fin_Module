...
public class AgentController {
    ...
    public void affichevente(ActionEvent event) throws IOException {
        Outils.load(event, "Page Produit", "/com/example/examen_javal3/teste.fxml");
    }

    public void stock(ActionEvent event) throws IOException {
        Outils.load(event, "Page Produit", "/com/example/examen_javal3/Stock.fxml");
    }
    ...
    public void Deconnexion(ActionEvent event) throws IOException {
        Outils.load(event,"Page d'acueil Admin","/com/example/examen_javal3/login.fxml");
    }
}
