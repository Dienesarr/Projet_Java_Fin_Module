...
public class VenteController implements Initializable {
    ...
    private void configurerColonne() {
        ...
        TableColumn<Produit, Integer> quantiteColonne = (TableColumn<Produit, Integer>) produitselectionner.getColumns().get(2);
    ...
    private void loadVentes() {
        String query = "SELECT v.id, v.date_vente, v.total, "
                ...
                + "GROUP_CONCAT(CONCAT(p.nom, ' (', vp.stock, ')')) AS produits "
                + "FROM ventes v "
    ...
    private void retour() throws IOException {
        ...
        Outils.load(null, "Page d'accueil", "/com/example/examen_javal3/AccueilAdmin.fxml");
    }

    @FXML
    private void Deconnexion() throws IOException {
        // Rediriger vers la page de connexion
        Outils.load(null, "Login", "/com/example/examen_javal3/login.fxml");
    }
}